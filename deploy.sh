...
kubectl set image deployments/client-deployment client=swaroopsalvi/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=swaroopsalvi/multi-worker:$SHA